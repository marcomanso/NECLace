 ...
 * @author marcomanso
 */
public class CreateBatchFiles_bck {
    ...
    public static String name_organization[] = {"COORDINATED", "COLLABORATIVE", "COLLABORATIVE2", "EDGE"};
    public static String organization[] = { "organization-N2C2M2-level1.txt",
                                            ...
                                            "organization-N2C2M2-level4.txt",
                                            "organization-N2C2M2-level4.5.txt",
    ...
    public static int getTL(int index) {
        return (index-2)/3;
    }
    public static int getWEB(int index) {
        return getTL(index)+16;
    }
    ...
    public static void killLinkTM_TL(int index, int[][] matrix) {
        //kill connection between TM (index) and respective TL + website
        int TLindex = getTL(index);
    ...
    public static void writeLinkDown(String dir, int orgIndex) {
        ...
        for (int i=5; i<NBR_SUBJECTS; i++) {
            killLinkTM_TL(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level"+label_organization[orgIndex]+"-linkdown-"+index+".txt";
    ...
    public static void write_1LinkDown(String dir, int orgIndex) {
        ...
        for (int i=5; i<NBR_SUBJECTS; i++) {
            ...
            //kill links ....
            killLinkTM_TL(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level"+label_organization[orgIndex]+"-1linkdown-"+index+".txt";
            if (orgIndex==INDEX_EDGE)
                writeOrganization(filename, name_organization[orgIndex], matrix, false);
            else
                writeOrganization(filename, name_organization[orgIndex], matrix, true);
        ...
        for (int i=1; i<5; i++) {
            ...
            matrix[i][0]=0;
            matrix[0][i]=0;
            matrix[i][NBR_SUBJECTS+i-1]=0;
            String filename = dir+File.separator+"organization-N2C2M2-level"+label_organization[orgIndex]+"-nodedown-"+index+".txt";
            if (orgIndex==INDEX_EDGE)
                writeOrganization(filename, name_organization[orgIndex], matrix, false);
            else
                writeOrganization(filename, name_organization[orgIndex], matrix, true);
    ...
    public static void write_2LinkDown(String dir, int orgIndex, int nbrRuns) {
        ...
        for (int i=5; i<NBR_SUBJECTS; i++) {
            ...
            for (int j=0; j<secondlinkIndex.length; j++) {
                killLinkTM_TL(secondlinkIndex[j], matrix);
    ...
    public static void writeNodeDown(String dir, int orgIndex) {
        ...
        killNode(0, matrix);
        String filename = dir+File.separator+"organization-N2C2M2-level"+label_organization[orgIndex]+"-nodedown-"+17+".txt";
        if (orgIndex==INDEX_EDGE)
            writeOrganization(filename, name_organization[orgIndex], matrix, false);
        else
            writeOrganization(filename, name_organization[orgIndex], matrix, true);
    ...
    public static void write_1NodeDown(String dir, int orgIndex) {
        ...
        for (int i=0; i<NBR_SUBJECTS; i++) {
            ...
            //kill node ....
            killNode(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level"+label_organization[orgIndex]+"-1nodedown-"+index+".txt";
            if (orgIndex==INDEX_EDGE)
                writeOrganization(filename, name_organization[orgIndex], matrix, false);
            else
                writeOrganization(filename, name_organization[orgIndex], matrix, true);
    ...
    public static void writeCoordinatedLinkDown(String dir) {
        int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
        fillMatrixCoordinated(matrix);
        //kill links ....
        int index = 1;
        for (int i=5; i<NBR_SUBJECTS; i++) {
            killLinkTM_TL(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level3-linkdown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_COORDINATED, matrix, true);
            index++;
        }
    }

    public static void writeCoordinated_1LinkDown(String dir) {
        int index = 1;
        for (int i=5; i<NBR_SUBJECTS; i++) {
            int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
            fillMatrixCoordinated(matrix);
            //kill links ....
            killLinkTM_TL(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level3-1linkdown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_COORDINATED, matrix, true);
            index++;
        }
    }

    public static void writeCoordinated_2LinkDown(String dir, int nbrRuns) {
        int index = 1;
        //generate random sequences for TMs in second link down
        int[] secondlinkIndex = new int[nbrRuns];
        ...
        for (int i=5; i<NBR_SUBJECTS; i++) {
            ...
            for (int j=0; j<secondlinkIndex.length; j++) {
                killLinkTM_TL(secondlinkIndex[j], matrix);
                String filename = dir+File.separator+"organization-N2C2M2-level3-2linkdown-"+index+"-"+(j+1)+".txt";
                writeOrganization(filename, Message.m_orgType_COORDINATED, matrix, true);
            }
            index++;
        }
    ...
    public static void writeCoordinatedNodeDown(String dir) {
        int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
        fillMatrixCoordinated(matrix);
        //kill nodes ....
        int index = 1;
        for (int i=5; i<NBR_SUBJECTS; i++) {
            killNode(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level3-nodedown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_COORDINATED, matrix, true);
            index++;
        }
        for (int i=1; i<5; i++) {
        ...
        killNode(0, matrix);
        String filename = dir+File.separator+"organization-N2C2M2-level3-nodedown-"+17+".txt";
        writeOrganization(filename, Message.m_orgType_COORDINATED, matrix, true);
    }

    public static void writeCoordinated_1NodeDown(String dir) {
        int index = 1;
        for (int i=0; i<NBR_SUBJECTS; i++) {
            int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
            fillMatrixCoordinated(matrix);
            //kill node ....
            killNode(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level3-1nodedown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_COORDINATED, matrix, true);
            index++;
        }
    }
    ...
    public static void writeCollaborativeLinkDown(String dir) {
        int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
        fillMatrixCollaborative(matrix);
        //kill links ....
        int index = 1;
        for (int i=5; i<NBR_SUBJECTS; i++) {
            killLinkTM_TL(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level4-linkdown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_COLLABORATIVE, matrix, true);
            index++;
        }
    }

    public static void writeCollaborative_1LinkDown(String dir) {
        //kill links ....
        int index = 1;
        for (int i=5; i<NBR_SUBJECTS; i++) {
            int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
            fillMatrixCollaborative(matrix);
            killLinkTM_TL(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level4-1linkdown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_COLLABORATIVE, matrix, true);
            index++;
        }
    }

    public static void writeCollaborative_2LinkDown(String dir, int nbrRuns) {
        int index = 1;
        //generate random sequences for TMs in second link down
        int[] secondlinkIndex = new int[nbrRuns];
        //TBD
        ...
        for (int i=5; i<NBR_SUBJECTS; i++) {
            ...
            for (int j=0; j<secondlinkIndex.length; j++) {
                killLinkTM_TL(secondlinkIndex[j], matrix);
                String filename = dir+File.separator+"organization-N2C2M2-level4-2linkdown-"+index+"-"+(j+1)+".txt";
                writeOrganization(filename, Message.m_orgType_COLLABORATIVE, matrix, true);
            }
            index++;
        }
    ...
    public static void writeCollaborativeNodeDown(String dir) {
        int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
        fillMatrixCollaborative(matrix);
        //kill nodes ....
        int index = 1;
        for (int i=5; i<NBR_SUBJECTS; i++) {
            killNode(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level4-nodedown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_COLLABORATIVE, matrix, true);
            index++;
        }
        for (int i=5; i<NBR_SUBJECTS; i++) {
    ...
    public static void writeCollaborative_1NodeDown(String dir) {
        int index = 1;
        for (int i=0; i<NBR_SUBJECTS; i++) {
            int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
            fillMatrixCollaborative(matrix);
            //kill node ....
            killNode(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level4-1nodedown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_COLLABORATIVE, matrix, true);
            index++;
        }
    }
    ...
    public static void writeCollaborative2LinkDown(String dir) {
        int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
        fillMatrixCollaborative2(matrix);
        //kill links ....
        int index = 1;
        for (int i=5; i<NBR_SUBJECTS; i++) {
            killLinkTM_TL(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level4.5-linkdown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_COLLABORATIVE2, matrix, true);
            index++;
        }
    }

    public static void writeCollaborative2_1LinkDown(String dir) {
        //kill links ....
        int index = 1;
        for (int i=5; i<NBR_SUBJECTS; i++) {
            int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
            fillMatrixCollaborative2(matrix);
            killLinkTM_TL(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level4.5-1linkdown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_COLLABORATIVE2, matrix, true);
            index++;
        }
    }

    public static void writeCollaborative2_2LinkDown(String dir, int nbrRuns) {
        int index = 1;
        //generate random sequences for TMs in second link down
        int[] secondlinkIndex = new int[nbrRuns];
        ...
        //TBD
            //check NOT TL
            //check NOT same subject
        System.arraycopy(TM_INDEX, 0, secondlinkIndex, 0, nbrRuns);
        ...
        for (int i=5; i<NBR_SUBJECTS; i++) {
            ...
            for (int j=0; j<secondlinkIndex.length; j++) {
                killLinkTM_TL(secondlinkIndex[j], matrix);
                String filename = dir+File.separator+"organization-N2C2M2-level4.5-2linkdown-"+index+"-"+(j+1)+".txt";
                writeOrganization(filename, Message.m_orgType_COLLABORATIVE2, matrix, true);
            }
            index++;
        }
    ...
    public static void writeCollaborative2NodeDown(String dir) {
        int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
        fillMatrixCollaborative2(matrix);
        //kill nodes ....
        int index = 1;
        for (int i=5; i<NBR_SUBJECTS; i++) {
            killNode(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level4.5-nodedown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_COLLABORATIVE2, matrix, true);
            index++;
        }
    }

    public static void writeCollaborative2_1NodeDown(String dir) {
        int index = 1;
        for (int i=0; i<NBR_SUBJECTS; i++) {
            int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
            fillMatrixCollaborative(matrix);
            //kill node ....
            killNode(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level4.5-1nodedown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_COLLABORATIVE2, matrix, true);
            index++;
        }
    }
    ...
    public static void writeEdgeLinkDown(String dir) {
        int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
        fillMatrixEdge(matrix);
        //kill links ....
        int index = 1;
        for (int i=5; i<NBR_SUBJECTS; i++) {
            killLinkTM_TL(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level5-linkdown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_EDGE, matrix, false);
            index++;
        }
    }

    public static void writeEdge_1LinkDown(String dir) {
        //kill links ....
        int index = 1;
        for (int i=5; i<NBR_SUBJECTS; i++) {
            int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
            fillMatrixEdge(matrix);
            killLinkTM_TL(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level5-1linkdown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_EDGE, matrix, false);
            index++;
        }
    }

    public static void writeEdge_2LinkDown(String dir, int nbrRuns) {
        int index = 1;
        //generate random sequences for TMs in second link down
        int[] secondlinkIndex = new int[nbrRuns];
        ...
        for (int i=5; i<NBR_SUBJECTS; i++) {
            ...
            for (int j=0; j<secondlinkIndex.length; j++) {
                killLinkTM_TL(secondlinkIndex[j], matrix);
                String filename = dir+File.separator+"organization-N2C2M2-level5-2linkdown-"+index+"-"+(j+1)+".txt";
                writeOrganization(filename, Message.m_orgType_EDGE, matrix, false);
            }
            index++;
        }
    ...
    public static void writeEdgeNodeDown(String dir) {
        int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
        fillMatrixEdge(matrix);
        //kill nodes ....
        int index = 1;
        for (int i=5; i<NBR_SUBJECTS; i++) {
            killNode(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level5-nodedown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_EDGE, matrix, false);
            index++;
        }
        for (int i=1; i<5; i++)  {
        ...
        killNode(0, matrix);
        String filename = dir+File.separator+"organization-N2C2M2-level5-nodedown-"+17+".txt";
        writeOrganization(filename, Message.m_orgType_EDGE, matrix, false);
    }

    public static void writeEdge_1NodeDown(String dir) {
        int[][] matrix = new int[NBR_SUBJECTS][NBR_SUBJECTS+WEBSITES_INDEX.length];
        //kill nodes ....
        int index = 1;
        for (int i=0; i<NBR_SUBJECTS; i++) {
            fillMatrixEdge(matrix);
            killNode(i, matrix);
            String filename = dir+File.separator+"organization-N2C2M2-level5-1nodedown-"+index+".txt";
            writeOrganization(filename, Message.m_orgType_EDGE, matrix, false);
            index++;
        }
    }

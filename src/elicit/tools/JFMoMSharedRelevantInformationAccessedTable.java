 ...
 * @author mmanso
 */
public class JFMoMSharedRelevantInformationAccessedTable extends JFMoMSharedInformationAccessedTable {

    public JFMoMSharedRelevantInformationAccessedTable(TrialData trialData) {
        super(trialData);
    }
    ...
    {
        this.setTitle("MoM: RELEVANT Information Reached (percentage over time)");
    }
